...
| Disclosure             | Discovering personal information or secrets of opposing party<br /> | Communication interception<br />Identity theft<br />Direct access to storage<br />Unauthorised access | Opposing party<br />Hacker<br />Government<br />Legitimate user |
...
| <a href="#attack-unauthorised">⇲</a> Unauthorised access     | Local app<br />Messaging<br />Search service  | Requires failure of components to apply authorisation controls |
